...
- [StepperPhaseElectrical test profile](doc/testing/stepper_phase_electrical.md) — the maintained
  actuator realization and reproducible simulator correlation scenario.
