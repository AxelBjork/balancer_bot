...
struct Config {
  ...
  static constexpr double fc_acc_corr_hz       = 1.75;    // Complementary accel correction (slow), 0.5–1.2 Hz: drift trim without lag
  ...
  static constexpr int   hz_balance      = 800;
  ...
  static constexpr double max_du_per_sec  = 35000;
  static constexpr double deadzone_frac   = 0.03;     // 5–10% of max_sps
  ...
  static constexpr double lqr_k_theta     = 6.00;
  static constexpr double lqr_k_dtheta    = 1.20;
  static constexpr double lqr_k_v         = 0.5;
  // Decay time constants
  static constexpr double lead_T_s        = 0.02;     // 30–60 ms works well; start 0.04
  static constexpr double desat_alpha     = 0.06;     // 0..1, pull toward clamp while saturated
  static constexpr double tau_u_s         = 0.08;

  // ========= App I/O =========
  static constexpr int    control_hz    = 800;
