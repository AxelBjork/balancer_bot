...
inline constexpr char kImuServiceDoc[] =
    ...
    "the controller's current view of body pitch, specific force, angular rate, and sample time.\n\n"
    ...
    "gyroscope vectors are then fused by a complementary filter before `ImuData` reaches control.\n\n"
