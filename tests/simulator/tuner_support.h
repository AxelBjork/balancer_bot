...
struct ScenarioMetrics {
  ...
  double slew_active_fraction = 0.0;
  double requested_applied_error_rms_sps = 0.0;
  double requested_applied_error_p95_sps = 0.0;
  double requested_applied_error_peak_sps = 0.0;
  double requested_command_delta_p95_sps = 0.0;
  double requested_command_delta_p99_sps = 0.0;
  double requested_command_delta_peak_sps = 0.0;
  double pitch_error_command_delta_p95_sps = 0.0;
  double pitch_error_command_delta_p99_sps = 0.0;
  double pitch_error_command_delta_peak_sps = 0.0;
  double pitch_rate_command_delta_p95_sps = 0.0;
  double pitch_rate_command_delta_p99_sps = 0.0;
  double pitch_rate_command_delta_peak_sps = 0.0;
  double pitch_accel_command_delta_p95_sps = 0.0;
  double pitch_accel_command_delta_p99_sps = 0.0;
  double pitch_accel_command_delta_peak_sps = 0.0;
  double pitch_target_command_delta_p95_sps = 0.0;
  double pitch_target_command_delta_p99_sps = 0.0;
  double pitch_target_command_delta_peak_sps = 0.0;
  double integrated_slew_excess_sps = 0.0;
  double longest_slew_limited_interval_s = 0.0;
...
struct TunerRankingSummary {
  ...
  double total_slew_excess_sps = 0.0;
  double worst_requested_command_delta_p95_sps = 0.0;
  double worst_requested_applied_error_p95_sps = 0.0;
