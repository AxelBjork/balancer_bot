...
_DEFAULT_COLUMNS = [
    ...
    "vel_i_term",
    "vel_p_term",
    "raw_common_mode_completed_step_velocity_sps",
    "pitch_motion_correction_sps",
    "corrected_axle_velocity_sps",
    "corrected_axle_velocity_mps",
    "nominal_acceleration_mps2",
    "commanded_acceleration_mps2",
    "acceleration_pitch_contribution_deg",
    "current_pitch_trim_deg",
    "target_vel_sps",
    "measured_vel_sps",
    "filtered_vel_sps",
