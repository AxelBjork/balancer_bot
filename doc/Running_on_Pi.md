...
dashboard requires the build manifest generated by `./build_cmake OFF` and refuses a stale or
unproven binary/config pair; rebuild before deploying if it reports a mismatch. **Start bot**
